"""Heroic Sszorak avoidable-damage summary wrapper."""
...
def fetch_sszorak_avoidable_damage_summary(
    *,
    report_code: str,
    ...
    return fetch_avoidable_damage_summary(
        ...
        boss_manifest=SSZORAK_HEROIC_MANIFEST,
...
__all__ = ["REPORT_DEFAULT_FIGHT", "fetch_sszorak_avoidable_damage_summary"]
