"""Heroic The Coiled Altar death summary wrapper."""
...
def fetch_the_coiled_altar_death_summary(
    *,
    report_code: str,
...
__all__ = ["REPORT_DEFAULT_FIGHT", "fetch_the_coiled_altar_death_summary"]
