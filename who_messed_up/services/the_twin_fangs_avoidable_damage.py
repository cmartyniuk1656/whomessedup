"""Heroic The Twin Fangs avoidable-damage summary wrapper."""
...
def fetch_the_twin_fangs_avoidable_damage_summary(
    *,
    report_code: str,
    ...
    return fetch_avoidable_damage_summary(
        ...
        boss_manifest=THE_TWIN_FANGS_HEROIC_MANIFEST,
...
__all__ = ["REPORT_DEFAULT_FIGHT", "fetch_the_twin_fangs_avoidable_damage_summary"]
