"""Heroic Ula'tek target-damage summary wrapper."""
from __future__ import annotations

from typing import Iterable, Optional

from .boss_manifests import ULA_TEK_HEROIC_MANIFEST
from .target_damage import EncounterTargetDamageSummary, fetch_encounter_target_damage_summary

REPORT_DEFAULT_FIGHT = "Ula'tek"
ULA_TEK_TARGETS = ULA_TEK_HEROIC_MANIFEST.target_configs
DEFAULT_TARGET_SLUGS = ULA_TEK_HEROIC_MANIFEST.default_target_slugs


def fetch_ula_tek_damage_summary(
    *,
    report_code: str,
    ...
    return fetch_encounter_target_damage_summary(
        ...
        target_configs=ULA_TEK_TARGETS,
