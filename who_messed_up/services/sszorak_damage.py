"""Heroic Sszorak target-damage summary wrapper."""
from __future__ import annotations

from typing import Iterable, Optional

from .boss_manifests import SSZORAK_HEROIC_MANIFEST
from .target_damage import EncounterTargetDamageSummary, fetch_encounter_target_damage_summary

REPORT_DEFAULT_FIGHT = "Sszorak"
SSZORAK_TARGETS = SSZORAK_HEROIC_MANIFEST.target_configs
DEFAULT_TARGET_SLUGS = SSZORAK_HEROIC_MANIFEST.default_target_slugs


def fetch_sszorak_damage_summary(
    *,
    report_code: str,
    ...
    return fetch_encounter_target_damage_summary(
        ...
        target_configs=SSZORAK_TARGETS,
...
__all__ = ["DEFAULT_TARGET_SLUGS", "REPORT_DEFAULT_FIGHT", "SSZORAK_TARGETS", "fetch_sszorak_damage_summary"]
