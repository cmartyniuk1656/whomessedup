"""Heroic The Lost Explorers death summary wrapper."""
...
def fetch_the_lost_explorers_death_summary(
    *,
    report_code: str,
...
__all__ = ["REPORT_DEFAULT_FIGHT", "fetch_the_lost_explorers_death_summary"]
