"""Heroic The Lost Explorers target-damage summary wrapper."""
from __future__ import annotations

from typing import Iterable, Optional

from .boss_manifests import THE_LOST_EXPLORERS_HEROIC_MANIFEST
...
THE_LOST_EXPLORERS_TARGETS = THE_LOST_EXPLORERS_HEROIC_MANIFEST.target_configs
DEFAULT_TARGET_SLUGS = THE_LOST_EXPLORERS_HEROIC_MANIFEST.default_target_slugs


def fetch_the_lost_explorers_damage_summary(
    *,
    report_code: str,
    ...
    return fetch_encounter_target_damage_summary(
        ...
        target_configs=THE_LOST_EXPLORERS_TARGETS,
