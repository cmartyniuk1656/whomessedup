"""Heroic The Lost Explorers avoidable-damage summary wrapper."""
...
def fetch_the_lost_explorers_avoidable_damage_summary(
    *,
    report_code: str,
    ...
    return fetch_avoidable_damage_summary(
        ...
        boss_manifest=THE_LOST_EXPLORERS_HEROIC_MANIFEST,
...
__all__ = ["REPORT_DEFAULT_FIGHT", "fetch_the_lost_explorers_avoidable_damage_summary"]
