"""
Crown of the Cosmos avoidable-damage summary wrapper.
"""
...
from .boss_manifests import CROWN_OF_THE_COSMOS_MANIFEST

REPORT_DEFAULT_FIGHT = "Crown of the Cosmos"


def fetch_crown_of_the_cosmos_avoidable_damage_summary(
    *,
    report_code: str,
    ...
    return fetch_avoidable_damage_summary(
        ...
        boss_manifest=CROWN_OF_THE_COSMOS_MANIFEST,
