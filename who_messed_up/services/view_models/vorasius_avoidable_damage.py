"""
View-model builder for the v2 Vorasius avoidable damage report page.
"""
from __future__ import annotations

from ..avoidable_damage import AvoidableDamageSummary
from ..vorasius_avoidable_damage import REPORT_DEFAULT_FIGHT
from .avoidable_damage import AvoidableDamagePageConfig, build_avoidable_damage_report_page

REPORT_ID = "vorasius-avoidable-damage"
REPORT_TITLE = "Mythic Vorasius - Avoidable Damage Report"
REPORT_DESCRIPTION = "Track avoidable damage taken during Mythic Vorasius pulls."
REPORT_FOOTNOTES = [
...
def build_vorasius_avoidable_damage_report_page(summary: AvoidableDamageSummary):
