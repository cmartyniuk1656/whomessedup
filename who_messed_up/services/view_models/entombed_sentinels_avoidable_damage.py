"""View-model builder for the Heroic Entombed Sentinels avoidable damage report."""
...
def build_entombed_sentinels_avoidable_damage_report_page(summary: AvoidableDamageSummary):
