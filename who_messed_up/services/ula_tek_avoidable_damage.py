"""Heroic Ula'tek avoidable-damage summary wrapper."""
...
def fetch_ula_tek_avoidable_damage_summary(
    *,
    report_code: str,
    ...
    return fetch_avoidable_damage_summary(
        ...
        boss_manifest=ULA_TEK_HEROIC_MANIFEST,
...
__all__ = ["REPORT_DEFAULT_FIGHT", "fetch_ula_tek_avoidable_damage_summary"]
