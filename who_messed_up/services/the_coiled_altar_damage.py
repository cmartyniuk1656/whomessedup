"""Heroic The Coiled Altar target-damage summary wrapper."""
...
THE_COILED_ALTAR_TARGETS = THE_COILED_ALTAR_HEROIC_MANIFEST.target_configs
DEFAULT_TARGET_SLUGS = THE_COILED_ALTAR_HEROIC_MANIFEST.default_target_slugs


def fetch_the_coiled_altar_damage_summary(
    *,
    report_code: str,
    ...
    return fetch_encounter_target_damage_summary(
        ...
        target_configs=THE_COILED_ALTAR_TARGETS,
