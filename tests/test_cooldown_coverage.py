...
class CoverageTests(unittest.TestCase):
    ...
    def test_death_markers_exclude_pets_and_preserve_repeat_deaths_and_pull_boundaries(self):
        events = [self.event(0, time, kind=kind, targetID=target) for target, time, kind in [
            (1, 0, "death"), (2, 20.125, "death"), (2, 20.125, "instakill"),
            (99, 20, "death"), (1, -1, "death"), (1, 301, "death"),
    ...
    def test_fetches_all_matching_pulls_and_separate_enemy_cast_stream(self, fights, streams, labels):
        ...
        self.assertEqual(streams.call_args.kwargs["streams"]["deaths"]["data_type"], "Deaths")
