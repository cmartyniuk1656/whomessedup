...
from who_messed_up.services.defensive_usage import fetch_defensive_usage
from who_messed_up.services.view_models.defensive_usage import build_defensive_usage_page
from who_messed_up.services.report_registry import JOB_V2_DEFENSIVE_USAGE
...
def _execute_v2_defensive_usage_job(payload: Dict[str, Any]) -> Dict[str, Any]:
    timeline = fetch_defensive_usage(report_codes=payload["report_codes"],
        encounter_id=payload["encounter_id"], difficulty=payload["difficulty"],
        **_client_credentials())
    return build_defensive_usage_page(timeline, payload["report_id"]).model_dump(by_alias=True)
...
job_manager.register_handler(JOB_V2_DEFENSIVE_USAGE, _execute_v2_defensive_usage_job)
